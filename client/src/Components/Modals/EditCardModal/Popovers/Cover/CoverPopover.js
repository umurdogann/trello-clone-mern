		...
		<Container>
			...
			<SizeContainer>
				<SizeWrapper onClick={() => handleColorClick(card.cover.color,true)} show={card.cover.color}>
					<SizeTypeOne selected={card.cover.color && card.cover.isSizeOne !== null && card.cover.isSizeOne} color={card.cover.color} />
				</SizeWrapper>
				<SizeWrapper onClick={() => handleColorClick(card.cover.color,false)} show={card.cover.color}>
					<SizeTypeTwo selected={card.cover.color  &&  card.cover.isSizeOne !== null && ! card.cover.isSizeOne} color={card.cover.color } />
				</SizeWrapper>
			</SizeContainer>
			<Title>Colors</Title>
